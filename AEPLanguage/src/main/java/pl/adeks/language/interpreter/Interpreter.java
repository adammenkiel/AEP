package pl.adeks.language.interpreter;

import lombok.Getter;
import pl.adeks.language.interpreter.data.LanguageData;
import pl.adeks.language.interpreter.data.math.bool.BooleanExpressionManager;
import pl.adeks.language.interpreter.data.math.number.AlgebraicExpressionManager;
import pl.adeks.language.interpreter.data.types.PrintData;
import pl.adeks.language.interpreter.data.types.conditions.ConditionData;
import pl.adeks.language.interpreter.data.types.ModifyVariableData;
import pl.adeks.language.interpreter.data.types.VariableData;
import pl.adeks.language.interpreter.data.types.conditions.WhileData;
import pl.adeks.language.interpreter.data.types.variables.bool.BooleanVariable;
