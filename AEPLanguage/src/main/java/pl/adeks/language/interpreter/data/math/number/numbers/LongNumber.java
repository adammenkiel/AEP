...
@Getter
@NoArgsConstructor
public class LongNumber extends LanguageNumber<Long> {
    ...
    public LanguageNumber<?> plus(LanguageNumber<?> other) {
        return switch (other) {
            case ByteNumber val -> new LongNumber(this.value + val.getValue());
            case ShortNumber val -> new LongNumber(this.value + val.getValue());
            case IntegerNumber val -> new LongNumber(this.value + val.getValue());
